...
void mt_pll_post_init(void)
{
    ...
    unsigned int downgrade = ((((seclib_get_devinfo_with_index(3) >> 0) & 0x7) == 0x4) || \
		    (((seclib_get_devinfo_with_index(3) >> 12) & 0x7) == 0x6)) ? 1 : 0; //CPU 1.3G or GPU 450
    ...
    if (TYPE_LPDDR2 == DDR_type) {
        ...
        if (spbin == 1) { // MT6753T
            if ((ddr1466 == 1) || (downgrade == 1)) { // DDR1466
