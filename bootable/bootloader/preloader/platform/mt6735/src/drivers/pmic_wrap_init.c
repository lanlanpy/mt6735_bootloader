 ...
 // WRAP_WR32(PMIC_WRAP_STAUPD_GRPEN,WRAP_RD32(PMIC_WRAP_STAUPD_GRPEN)|0x35);
  ...
  if( sub_return != 0 )
  {
   ...
   PWRAPLOG("mt_pwrap_init PMIC_WRAP_STAUPD_GRPEN(%x)\n",WRAP_RD32(PMIC_WRAP_STAUPD_GRPEN));
	...
	WRAP_WR32(PMIC_WRAP_ADC_RDATA_ADDR     , MT6328_AUXADC_ADC16);
  ...
  #else
  WRAP_WR32(PMIC_WRAP_HARB_HPRIO, 0x2ef);/* Adjust coclk priority, improve wacs2 priority*/
  WRAP_WR32(PMIC_WRAP_HIPRIO_ARB_EN,0x3ff);
  PWRAPLOG("mt_pwrap_init-- use D1 or D3 [reg PMIC_WRAP_HARB_HPRIO:0x%x]\n",WRAP_RD32(PMIC_WRAP_HARB_HPRIO));
  #endif
  ...
  WRAP_WR32(PMIC_WRAP_WACS3_EN,ENABLE);
	...
	WRAP_WR32(PMIC_WRAP_INT_EN,0xfffffbfb); 
