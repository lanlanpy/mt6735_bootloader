...
#if defined(GPIO_I2C4_SDA_PIN) && defined(GPIO_I2C4_SDA_PIN_M_SDA_EXTB) && defined(GPIO_I2C4_SCA_PIN) && defined(GPIO_I2C4_SCA_PIN_M_SCL_EXTB)
	mt_set_gpio_mode(GPIO_I2C4_SDA_PIN, GPIO_I2C4_SDA_PIN_M_SDA_EXTB);
	mt_set_gpio_mode(GPIO_I2C4_SCA_PIN, GPIO_I2C4_SCA_PIN_M_SCL_EXTB);
	mt_set_gpio_dir(GPIO_I2C4_SDA_PIN,GPIO_DIR_IN);
	mt_set_gpio_dir(GPIO_I2C4_SCA_PIN,GPIO_DIR_IN);
	mt_set_gpio_pull_enable(GPIO_I2C4_SDA_PIN,GPIO_PULL_ENABLE);
	mt_set_gpio_pull_enable(GPIO_I2C4_SCA_PIN,GPIO_PULL_ENABLE);
	mt_set_gpio_pull_select(GPIO_I2C4_SDA_PIN,GPIO_PULL_UP);
	mt_set_gpio_pull_select(GPIO_I2C4_SCA_PIN,GPIO_PULL_UP);
	I2CLOG("GPIO128: MODE:%d,DIR:%d,ENABLE:%d,PullHigh:%d\n",
			mt_get_gpio_mode(GPIO_I2C4_SDA_PIN),
			mt_get_gpio_dir(GPIO_I2C4_SDA_PIN),
			mt_get_gpio_pull_enable(GPIO_I2C4_SDA_PIN),
			mt_get_gpio_pull_select(GPIO_I2C4_SDA_PIN) );
	I2CLOG("GPIO129: MODE:%d,DIR:%d,ENABLE:%d,PullHigh:%d\n",
			mt_get_gpio_mode(GPIO_I2C4_SCA_PIN),
			mt_get_gpio_dir(GPIO_I2C4_SCA_PIN),
			mt_get_gpio_pull_enable(GPIO_I2C4_SCA_PIN),
			mt_get_gpio_pull_select(GPIO_I2C4_SCA_PIN) );
#endif
	return 0;
}
