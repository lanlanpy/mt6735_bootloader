...
void bq24158_turn_on_charging(void)
{
    ...
    bq24158_config_interface_liao(0x00,0x80);//0xC0);
    bq24158_config_interface_liao(0x01,0xb8);
...
void bq24158_hw_init(void)
{
    ...
    //bq24158_config_interface_liao(0x02,0xa6); // 4.32
#else
